...
export const AboutMe = () =>{
    return(
        <main className="flex flex-wrap-reverse justify-center items-center gap-10 md:gap-32 py-8 px-20 text-lg text-center xl:text-left xl:flex-nowrap xl:justify-between">
